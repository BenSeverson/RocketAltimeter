...
rom USB_DEV_DSC device_dsc=
{
    ...
    0x04D8,                 // Vendor ID
    0x0055,                 // Product ID: ben - changed
    0x0100,                 // Device release number in BCD format ben - trying to get 1.0
...
CFG01={
    ...
    HID_INTF,               // Class code
    0, //BOOT_INTF_SUBCLASS,     // Subclass code		//ben change? pickit2=0
    0,     // Protocol code		//ben change? pickit2=0(none) or HID_PROTOCOL_NONE
...
sizeof(sd000),DSC_STR,0x0409};		// ben - device serial number, change?
