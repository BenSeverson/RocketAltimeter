...
int main(int argc, char *argv[]) {
	...
	while(1)
	{
		intensity[1][1].red = 15;

		intensity[0][0].red = 15;
		intensity[2][2].red = 15;
		write_colors(file,intensity);
		intensity[0][0].red = 0;
		intensity[2][2].red = 0;
		usleep(50000);

		intensity[0][1].red = 15;
		intensity[2][1].red = 15;
		write_colors(file,intensity);
		intensity[0][1].red = 0;
		intensity[2][1].red = 0;
		usleep(50000);

		intensity[0][2].red = 15;
		intensity[2][0].red = 15;
		write_colors(file,intensity);
		intensity[0][2].red = 0;
		intensity[2][0].red = 0;
		usleep(50000);

		intensity[1][2].red = 15;
		intensity[1][0].red = 15;
		write_colors(file,intensity);
		intensity[1][2].red = 0;
		intensity[1][0].red = 0;
		usleep(50000);
