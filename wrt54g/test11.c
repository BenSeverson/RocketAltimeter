...
int main(int argc, char *argv[]) {
	...
	while(1)
	{
		for(j=0;j<16;j++)
		{
			for(row=0;row<3;row++)
				for(column=0;column<3;column++)
					intensity[row][column].red = intensity[row][column].blue = j;
			write_colors(file,intensity);
			usleep(50000);
		}
		for(j=0;j<15;j++)
		{
			for(row=0;row<3;row++)
				for(column=0;column<3;column++)
					intensity[row][column].red = intensity[row][column].red - 1;
			write_colors(file,intensity);
			usleep(50000);
		}
		for(j=1;j<16;j++)
		{
			for(row=0;row<3;row++)
				for(column=0;column<3;column++)
					intensity[row][column].green = intensity[row][column].green + 1;
			write_colors(file,intensity);
			usleep(50000);
		}
		for(j=0;j<15;j++)
		{
			for(row=0;row<3;row++)
				for(column=0;column<3;column++)
					intensity[row][column].blue = intensity[row][column].blue - 1;
			write_colors(file,intensity);
			usleep(50000);
		}
		for(j=1;j<16;j++)
