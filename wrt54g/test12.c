	...
	while(1)
	{
		for(j=0;j<16;j++)
		{
			...
			{	for(column=2;column>=0;column--)
					intensity[row][column] = intensity[row-1][0];
			}
			intensity[0][0].red = intensity[0][0].blue = j;
			intensity[0][1].red = intensity[0][1].blue = j;
			intensity[0][2].red = intensity[0][2].blue = j;
			write_colors(file,intensity);
			usleep(50000);
		}
		for(j=0;j<15;j++)
		{
			...
			intensity[0][0].red = intensity[0][0].red - 1;
			intensity[0][1].red = intensity[0][1].red - 1;
			intensity[0][2].red = intensity[0][2].red - 1;
			write_colors(file,intensity);
			usleep(50000);
		}
		for(j=1;j<16;j++)
		{
			...
			intensity[0][0].green = intensity[0][0].green + 1;
			intensity[0][1].green = intensity[0][1].green + 1;
			intensity[0][2].green = intensity[0][2].green + 1;
			write_colors(file,intensity);
			usleep(50000);
		}
		for(j=0;j<15;j++)
		{
			...
			intensity[0][0].blue = intensity[0][0].blue - 1;
			intensity[0][1].blue = intensity[0][1].blue - 1;
			intensity[0][2].blue = intensity[0][2].blue - 1;
			write_colors(file,intensity);
			usleep(50000);
		}
		for(j=1;j<16;j++)
